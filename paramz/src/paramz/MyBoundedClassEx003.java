 ...
 * What happens in case we want to access group of objects comes from same family, means extending same super class?
 *  You can restrict the generics type parameter to a certain group of objects which extends same super class. 
 *  You can achieve this my specifying extends <super-class> at class definitions, look at the example, 
 *  it gives you more comments to understand.
 * 
 * */

public class MyBoundedClassEx003 {
