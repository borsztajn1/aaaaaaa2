...
Look at the generics class definition,
 the type parameter should be followed by class name and should contain with in <>, 
 here T defines the type parameter. You can find comments at example itself.
 * */
public class MySimpleGenerics002 {
