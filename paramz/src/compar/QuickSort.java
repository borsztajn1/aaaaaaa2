...
//
http://cs.brynmawr.edu/Courses/cs206/fall2015/LectureNotes/Day16[Nov5].pdfimport java.util.Comparator;
...
public class QuickSort<T extends Comparable> {
     ...
     */
    public static <T extends Comparable> void sort(List<T> a) {  sort(a, 0, a.size() - 1);    }
     ...
     */
    public static <T> void sort(List<T> a, Comparator<T> comparator) { sort(a, 0, a.size() - 1, comparator);  }
