...
public class HashMap2<K, V> implements HashMapInterface2<K, V> {

    // Do not make any new instance variables.
    private MapEntry2<K, V>[] table;
    private int size;
     ...
     */
    public HashMap2() {
        table = new MapEntry2[STARTING_SIZE];
        size = 0;
    }
    ...
    public V add(K key, V value) {
        ...
        int ogIndex = index;
        MapEntry2<K, V> entry = new MapEntry2<K, V>(key, value);
     ...
     */
    private V checkDuplicate(MapEntry2<K, V> entry, int quadratic, int ogIndex) {
     ...
     */
    private void regrow() {
        MapEntry2<K, V>[] tempTable = table;
        int actSize = size;
        table = new MapEntry2[table.length * 2 + 1];
