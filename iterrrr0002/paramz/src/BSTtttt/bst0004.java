...
Node node = this.search(key);
// Szukanie poprzednika gdy wêze³ ma lewego potomka
if(node.left != null) {
node = node.left;
while(node.right != null)
node = node.right;
...
// Szukanie poprzednika gdy wêze³ nie ma lewego potomka
